...
import com.tdme.android.musicalbums.SearchResultAdapter;
import com.tdme.android.musicalbums.SegmentedGroup;
...
public class MapActivity extends AppCompatActivity implements LocationSource,
    ...
    private void initView() {
        ...
        backBtn = (ImageView) findViewById(R.id.back_map);
        backBtn.setOnClickListener(this);
        finishBtn = (ImageView) findViewById(R.id.finish_map);
...
//        Log.i("MY", "doSearchQuery");
    ...
    public void onRegeocodeSearched(RegeocodeResult result, int rCode) {
        ...
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
            ...
            Toast.makeText(MapActivity.this, "error code is " + rCode, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    Inputtips.InputtipsListener inputtipsListener = new Inputtips.InputtipsListener() {
        ...
        public void onGetInputtips(List<Tip> list, int rCode) {
            if (rCode == AMapException.CODE_AMAP_SUCCESS) {// 正确返回
                ...
                Toast.makeText(MapActivity.this, "erroCode " + rCode, Toast.LENGTH_SHORT).show();
            }
        }
    };
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.finish_map:
                ...
                intent.putExtra("locationCoordinate", searchResultAdapter.getSelectedPoiItem().getLatLonPoint().toString());
